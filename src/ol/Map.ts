...
export interface FrameState {
  pixelRatio: number;
  time: number;
  viewState: import("./View").State;
  animate: boolean;
  coordinateToPixelTransform: import("./transform").Transform;
  declutterTree: RBush<any>;
  extent: null | import("./extent").Extent;
  nextExtent?: import("./extent").Extent;
  index: number;
  layerStatesArray: LayerState[];
  layerIndex: number;
  pixelToCoordinateTransform: import("./transform").Transform;
