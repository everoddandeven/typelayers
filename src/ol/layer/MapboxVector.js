 ...
 * other than `ol-layer`.
 * @property {import("./Base").BackgroundColor|false} [background] Background color for the layer.
 ...
 * @property {import("./VectorTile").VectorTileRenderType} [renderMode='hybrid'] Render mode for vector tiles:
