...
/**
 * A function that takes an {@link module:tl/Image~ImageWrapper} for the image and a
 * `{string}` for the src as arguments. It is supposed to make it so the
 * underlying image {@link module:tl/Image~ImageWrapper#getImage} is assigned the
