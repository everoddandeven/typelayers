 ...
 * It takes two instances of {@link module:tl/Feature~Feature} or
 * {@link module:tl/render/Feature~RenderFeature} and returns a `{number}`.
 *
 ...
 * ```js
 * import {toContext} from 'tl/render';
 * import Fill from 'tl/style/Fill';
