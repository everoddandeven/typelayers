 ...
 * @type {Transform}
 */
const tmp_: Transform = [0, 0, 0, 0, 0, 0];
 ...
 * @param {import("./coordinate").Coordinate|import("./pixel").Pixel} coordinate The coordinate to transform.
 * @return {import("./coordinate").Coordinate|import("./pixel").Pixel} return coordinate so that operations can be
 *     chained together.
 */
export function apply(transform: Transform, coordinate: Coordinate | Pixel): Coordinates | Pixel {
 ...
 * @private
 */
let transformStringDiv: HTMLElement;
