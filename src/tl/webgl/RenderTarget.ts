 ...
 * @module tl/webgl/RenderTarget
 */
import {equals} from '../array';
import WebGLHelper from "./Helper";

// for pixel color reading
const tmpArray4: Uint8Array = new Uint8Array(4);
...
class WebGLRenderTarget {
   ...
   * @api
   */
  public readPixel(x: number, y: number): Uint8Array {
   ...
   */
  public getDepthbuffer(): WebGLRenderbuffer {
