 ...
 *
 * ```js
 * import TileState from 'tl/TileState';
 *
 * source.setTileLoadFunction(function(tile, src) {
...
/**
 * {@link module:tl/source/Tile~TileSource} sources use a function of this type to get
 * the url that provides a tile for a given tile coordinate.
 *
 * This function takes an {@link module:tl/tilecoord~TileCoord} for the tile
 * coordinate, a `{number}` representing the pixel ratio and a
 * {@link module:tl/proj/Projection~Projection} for the projection  as arguments
...
abstract class Tile extends EventTarget {
  ...
  release() {
    if (this.state === TileState.ERROR) {
      // to remove the `change` listener on this tile in `tl/TileQueue#handleTileChange`
