...
export default class Circle extends SimpleGeometry {
  ...
  /**
   * Return the center of the circle as {@link module:tl/coordinate~Coordinate coordinate}.
  ...
  /**
   * Set the center of the circle as {@link module:tl/coordinate~Coordinate coordinate}.
   * @param {import("../coordinate").Coordinate} center Center.
   * @api
   */
  ...
  /**
   * Set the center (as {@link module:tl/coordinate~Coordinate coordinate}) and the radius (as
