/**
 * @module tl/renderer/webgl/PointsLayer
 */
...
import {AttributeType, DefaultUniform, UniformValue} from '../../webgl/Helper';
...
{
  name: string;
  callback: (feature: Feature, dict: {[key: string]: any}) => number;
}
 ...
 * {@link module:tl/webgl/ShaderBuilder~ShaderBuilder} utilities. These shaders shall expect a `a_position` attribute
 ...
 *  ```
 *
 * This uses {@link module:tl/webgl/Helper~WebGLHelper} internally.
 *
 * @api
 */
