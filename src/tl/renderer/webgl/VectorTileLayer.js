...
class WebGLVectorTileLayerRenderer extends WebGLBaseTileLayerRenderer {
   ...
   * @param {import("../../extent").Extent} renderExtent Which extent to restrict drawing to
