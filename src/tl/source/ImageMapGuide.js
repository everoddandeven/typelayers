/**
 * @module tl/source/ImageMapGuide
 */
...
class ImageMapGuide extends ImageSource {
  ...
  getUrl(baseUrl, params, extent, size, projection) {
    ...
    const baseParams = {
      ...
      'VERSION': '2.0.0',
      'LOCALE': 'en',
      'CLIENTAGENT': 'tl/source/ImageMapGuide source',
      'CLIP': '1',
...
/**
 * @param {import("../extent").Extent} extent The map extents.
 * @param {import("../size").Size} size The viewport size.
