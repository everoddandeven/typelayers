...
export class CustomTile extends Tile {
   ...
   * @param {import("../extent").Extent} extent Extent of the tile.
...
class UTFGrid extends TileSource {
  ...
  /**
   * TODO: very similar to tl/source/TileJSON#handleTileJSONResponse
   * @protected
