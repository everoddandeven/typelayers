...
export class CustomTile extends ImageTile {
  /**
   * @param {import("../size").Size} tileSize Full tile size.
 ...
 * @property {import("../size").Size} size Size.
 * @property {import("../extent").Extent} [extent] Extent for the TileGrid that is created.
