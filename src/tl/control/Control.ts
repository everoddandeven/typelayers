 ...
 * container with CSS class name `tl-overlaycontainer-stopevent`, but can use
 ...
 * will also be objects in a {@link module:tl/Collection~Collection}, so you can use their methods.
 *
...
export default class Control extends BaseObject {
   ...
   * @api
   */
  public setTarget(target: HTMLElement | string): void {
    this.target_ =
