/**
 * @module tl/contrtl/ZoomToExtent
 */
 ...
 * extent. To style this control use the css selector `.tl-zoom-extent`.
 *
 * @api
 */
class ZoomToExtent extends Control {
  ...
  constructor(options: ZoomToExtentOptions) {
    ...
    const className =
      options.className !== undefined ? options.className : 'tl-zoom-extent';
