...
class WkbReader {
  ...
  readWkbHeader(expectedTypeId) {
    ...
    const layout = /** @type {import("../geom/Geometry").GeometryLayout} */ (
  ...
  /**
   * @return {Array<import('../geom/Geometry').default>} array of geometries
   */
    ...
    switch (typeId) {
      ...
      case WKBGeometryType.GEOMETRY_COLLECTION:
        return new GeometryCollection(
          /** @type {Array<import('../geom/Geometry').default>} */ (result)
        );
...
class WkbWriter {
   ...
   * @param {import("../geom/Geometry").GeometryLayout} layout layout
   */
  ...
  /**
   * @param {Array<import('../geom/Geometry').default>} geometries geometries
   */
  ...
  /**
   * @param {import("../geom/Geometry").default} geom geometry
   * @param {import("../geom/Geometry").GeometryLayout} [layout] layout
   * @return {import("../geom/Geometry").GeometryLayout} minimum layout made by common axes
   */
  findMinimumLayout(geom, layout = 'XYZM') {
    /**
     * @param {import("../geom/Geometry").GeometryLayout} a A
     * @param {import("../geom/Geometry").GeometryLayout} b B
     * @return {import("../geom/Geometry").GeometryLayout} minimum layout made by common axes
     */
  ...
  writeGeometry(geom, srid) {
    /**
     * @type {Object<import("../geom/Geometry").Type, WKBGeometryType>}
     */
    const wkblut = {
 ...
 * @property {import("../geom/Geometry").GeometryLayout} [geometryLayout=null] Use specific coordinate layout for output features (null: auto detect)
