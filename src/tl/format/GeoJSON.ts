...
export type GeoJSONObject = GeoJson.GeoJSON;
...
export type GeoJSONPolygon = GeoJson.Polygon;
export type GeoJSONMultiPoint = GeoJson.MultiPoint;
export type GeoJSONMultiPolygon = GeoJson.MultiPolygon;
export type GeoJSONGeometryCollection = GeoJson.GeometryCollection;

interface GeoJSONOptions {
  dataProjection?: import("../proj").ProjectionLike;
  featureProjection?: import("../proj").ProjectionLike;
  geometryName?: string;
...
class GeoJSON extends JSONFeature {
  ...
  private extractGeometryName_?: boolean;
  ...
  switch (object['type']) {
    ...
    case 'GeometryCollection': {
      geometry = readGeometryCollectionGeometry(
        /** @type {GeoJSONGeometryCollection} */ (<GeoJSONGeometryCollection>object)
      );
      break;
    }
    default: {
...
function readGeometryCollectionGeometry(object, options?) {
  const geometries = object['geometries'].map(
     ...
     * @return {import("../geom/Geometry").default} geometry Geometry.
     */
    function (geometry) {
 ...
 */
function readMultiPointGeometry(object): MultiPoint {
