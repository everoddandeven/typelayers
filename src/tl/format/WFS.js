/**
 * @module tl/format/WFS
 */
import GML2 from './GML2';
import GML3 from './GML3';
import GML32 from './GML32';
 ...
 * Default is `tl/format/GML2` for WFS 1.0.0, `tl/format/GML3` for WFS 1.1.0 and `tl/format/GML32` for WFS 2.0.0.
 ...
 * @property {import("../extent").Extent} [bbox] Extent to use for the BBOX filter. The `geometryName`
 * option must be set.
 * @property {import("./filter/Filter").default} [filter] Filter condition. See
 * {@link module:tl/format/filter} for more information.
 ...
 * @property {!import("../extent").Extent} bbox Extent to use for the BBOX filter.
 ...
 * @property {import("../extent").Extent} bounds Bounds.
 */
 ...
 * Also see {@link module:tl/format/GMLBase~GMLBase} which is used by this format.
 *
 * @api
 */
