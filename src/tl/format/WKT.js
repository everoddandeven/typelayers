 ...
 * @enum {function (new:import("../geom/Geometry").default, Array, import("../geom/Geometry").GeometryLayout)}
 */
...
/**
 * @type {Object<import("../geom/Geometry").Type, string>}
 */
const wktTypeLookup = {
  Point: 'POINT',
  LineString: 'LINESTRING',
...
class Parser {
   ...
   * @return {import("../geom/Geometry").default} The geometry.
   */
  parse() {
    this.consume_();
   ...
   * @return {import("../geom/Geometry").GeometryLayout} The layout.
   * @private
   */
  ...
  /**
   * @return {Array<import("../geom/Geometry").default>} A collection of geometries.
   * @private
   */
...
class WKT extends TextFeature {
   ...
   * Parse a WKT string.
   * @param {string} wkt WKT string.
   * @return {import("../geom/Geometry").default}
...
/**
 * @param {LineString|import("../geom/LinearRing").default} geom LineString geometry.
...
/**
 * @param {import("../geom/SimpleGeometry").default} geom SimpleGeometry geometry.
...
/**
 * @const
 * @type {Object<string, function(import("../geom/Geometry").default): string>}
 */
 ...
 * @param {import("../geom/Geometry").default} geom The geometry to encode.
...
function encode(geom) {
  ...
  if (typeof (/** @type {?} */ (geom).getFlatCoordinates) === 'function') {
    const dimInfo = encodeGeometryLayout(
      /** @type {import("../geom/SimpleGeometry").default} */ (geom)
    );
    if (dimInfo.length > 0) {
      wktType += ' ' + dimInfo;
    }
