...
/**
 * @type {Object<string, import("../style/Icon").IconAnchorUnits>}
 */
 ...
 * @param {import("../size").Size} size Image size.
 * @return {number} Scale.
 */
 ...
 *
 * {@link module:tl/format/KML~KML#readFeature} will read the first feature from
 * a KML source.
 *
...
function readMultiGeometry(node, objectStack) {
  ...
  return /** @type {import("../geom/Geometry").default} */ (multiGeometry);
}
 ...
 * @param {Array<import("../geom/Geometry").default>} geometries List of geometries.
 */
  ...
  if (value) {
    ...
    return createElementNS(
      ...
      GEOMETRY_TYPE_TO_NODENAME[
        /** @type {import("../geom/Geometry").default} */ (value).getType()
      ]
    );
  }
};
...
function writeMultiGeometry(node, geometry, objectStack) {
  ...
  const type = geometry.getType();
  /** @type {Array<import("../geom/Geometry").default>} */
  let geometries = [];
  /** @type {function(*, Array<*>, string=): (Node|undefined)} */
  let factory;
  if (type === 'GeometryCollection') {
...
/**
 * @param {Element} node Node.
 * @param {import("../geom/LinearRing").default} linearRing Linear ring.
 * @param {Array<*>} objectStack Object stack.
 */
