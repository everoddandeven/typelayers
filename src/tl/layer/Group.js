...
/**
 * @classdesc
 * A {@link module:tl/Collection~Collection} of layers that are handled together.
 *
...
class LayerGroup extends BaseLayer {
  ...
  /**
   * Returns the {@link module:tl/Collection~Collection collection} of {@link module:tl/layer/Layer~Layer layers}
   * in this group.
   * @return {!Collection<import("./Base").default>} Collection of
   *   {@link module:tl/layer/Base~BaseLayer layers} that are part of this group.
   * @observable
   * @api
   */
  getLayers() {
  ...
  /**
   * Set the {@link module:tl/Collection~Collection collection} of {@link module:tl/layer/Layer~Layer layers}
   * in this group.
