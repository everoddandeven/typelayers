/**
 * @module tl/interaction/Translate
 */
...
/**
 * A function that takes an {@link module:tl/Feature~Feature} or
 * {@link module:tl/render/Feature~RenderFeature} and an
...
/**
 * @classdesc
 * Events emitted by {@link module:tl/interaction/Translate~Translate} instances
...
export class TranslateEvent extends Event {
   ...
   * @param {import("../coordinate").Coordinate} startCoordinate The original coordinates before.translation started
...
class Translate extends PointerInteraction {
  ...
  handleMoveEvent(event) {
    ...
    if (this.featuresAtPixel_(event.pixel, event.map)) {
      elem.classList.remove(this.lastCoordinate_ ? 'tl-grab' : 'tl-grabbing');
      elem.classList.add(this.lastCoordinate_ ? 'tl-grabbing' : 'tl-grab');
    } else {
      elem.classList.remove('tl-grab', 'tl-grabbing');
    }
  }
