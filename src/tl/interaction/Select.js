...
/**
 * A function that takes an {@link module:tl/Feature~Feature} and returns `true` if the feature may be
 ...
 * By default, this is {@link module:tl/events/condition.never}. Use this if you
 ...
 * {@link module:tl/events/condition.singleClick}. Clicking on a feature selects that
 ...
 * (see {@link module:tl/style/Style~Style}). Set to `null` if this interaction should not apply
 ...
 * {@link module:tl/events/condition.shiftKeyOnly}, i.e. pressing `shift` as
 ...
 * {@link module:tl/interaction/Select~Select#getFeatures}.
 * @property {FilterFunction} [filter] A function
 * that takes an {@link module:tl/Feature~Feature} and an
 * {@link module:tl/layer/Layer~Layer} and returns `true` if the feature may be
 * selected or `false` otherwise.
...
/**
 * @classdesc
 * Events emitted by {@link module:tl/interaction/Select~Select} instances are instances of
 * this type.
 */
export class SelectEvent extends Event {
   ...
   *     {@link module:tl/MapBrowserEvent~MapBrowserEvent}.
   */
 ...
 * @type {Object<number, import("../style/Style").default|Array<import("../style/Style").default>|import("../style/Style").StyleFunction>}
 */
...
class Select extends Interaction {
  ...
  constructor(options) {
     ...
     * and layer (value)
     * @private
     * @type {Object<string, import("../layer/Layer").default>}
     */
  ...
  /**
   * Returns the associated {@link module:tl/layer/Vector~VectorLayer vector layer} of
   * a selected feature.
   * @param {import("../Feature").default} feature Feature
  ...
  /**
   * Handles the {@link module:tl/MapBrowserEvent~MapBrowserEvent map browser event} and may change the
