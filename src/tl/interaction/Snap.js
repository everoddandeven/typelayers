...
import {boundingExtent, buffer, createEmpty} from '../extent';
import {
  closestOnCircle,
  closestOnSegment,
  squaredDistance,
 ...
 * @property {import("../coordinate").Coordinate|null} vertex Vertex.
 ...
 * @property {Array<import("../coordinate").Coordinate>} segment Segment.
 */
 ...
 * features can come from a {@link module:tl/source/Vector~VectorSource} or {@link module:tl/Collection~Collection}
 ...
 * Example:
 *
 *     import Snap from 'tl/interaction/Snap';
 *
 *     const snap = new Snap({
 *       source: source
 *     });
...
class Snap extends PointerInteraction {
  ...
  constructor(options) {
     ...
     * @type {Object<string, import("../extent").Extent>}
     * @private
     */
     ...
     * event fired.
     * @type {!Object<string, import("../Feature").default>}
     * @private
     */
     ...
     * @const
     * @private
     * @type {Object<string, function(Array<Array<import('../coordinate').Coordinate>>, import("../geom/Geometry").default): void>}
     */
   ...
   * @param {import("../coordinate").Coordinate} pixelCoordinate Coordinate
   * @param {import("../Map").default} map Map.
